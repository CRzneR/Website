...
const Introduction: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // LEFT TEXT
      tl.from(
        leftRef.current?.querySelectorAll(".line"),
        {
          y: 100,
          opacity: 0,
          stagger: 0.2,
      ...
      // RIGHT TEXT
      tl.from(
        rightRef.current?.querySelectorAll(".line"),
        {
          y: 100,
          opacity: 0,
          stagger: 0.2,
  ...
  return (
    <div ref={containerRef} className="relative bg-[#151515] min-h-[300vh]">
      ...
      >
        ...
        <div
          ref={leftRef}
          className="absolute left-8 top-[40%] space-y-2"
        >
          <div className="line text-2xl font-bold">I CREATE STUNNING DIGITAL</div>
          <div className="line text-2xl font-bold">EXPERIENCES FOR CUSTOMERS</div>
          <div className="line text-2xl font-bold">WITH A FOCUS ON UX</div>
        </div>
        ...
        >
          <div className="line text-2xl font-bold">User Interface Design</div>
          <div className="line text-2xl font-bold">User Experience Design</div>
          <div className="line text-2xl font-bold">Frontend Development</div>
