...
export const metadata: Metadata = {
  title: "Chirstoph Renz - Webentwicklung",
  description:
    "Portfolio und Blog von Christoph Renz – Frontend- & Webentwickler für moderne Web- und App-Entwicklung mit aktuellen Technologien.",
};
